    ...
    return (
        <>
            ...
            >
                ...
                <Text as="p">
                    스타트업에서 3년간 웹뷰 기반 앱 서비스를 초기 구축부터
                    서비스 종료 시 까지 개발/운영한 경험이 있습니다.
                </Text>
                <Text as="p">
                    서비스의 성장에 기여하는 것에 관심이 많습니다. 비즈니스적
                    임팩트를 고려하여 일의 우선순위를 파악할 수 있도록
                    노력해왔으며, 동료들과 적극적으로 소통하고 아이디어를 빠르게
                    시도해보면서 확보한 데이터를 통해 서비스의 개선 방향을 찾고
                    사용자의 편의를 향상 시킬 수 있도록 고민해왔습니다.
                </Text>
                <Text as="p">
                    동료들에게 같이 일하고 싶은, 신뢰할 수 있는 사람이 되는 것이
                    저의 작은 목표입니다.
                </Text>
            </Box>
        </>
