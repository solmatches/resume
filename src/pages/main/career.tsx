...
import { Box, Container as ContainerComponent, ListItem, Text } from '~/components';
...
const Career: FC = () => {
  return (
    <>
      ...
      <Section>
        <h1>경력</h1>
        {careers.map(({ companyName, position, period, description, projects }) => (
          <ProjectContainer key={companyName} style={{ marginTop: '4rem' }}>
            <Company>
              <h3>{companyName}</h3>
